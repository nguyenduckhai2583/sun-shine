...
GoRouter createRouter({
  ...
  routes: [
    ...
    // could never reach a repository mounted by the list page.
    //
    ...
    ShellRoute(
      builder: (context, state, child) => MultiRepositoryProvider(
        providers: [
          RepositoryProvider<TeacherApiClient>(
            create: (context) => TeacherApiClient(),
          ),
          RepositoryProvider<TeacherLocalService>(
