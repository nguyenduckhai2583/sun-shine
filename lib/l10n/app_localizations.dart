...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Start a new conversation with the team'**
  ...
  /// No description provided for @continueWithPasskey.
  ///
  /// In en, this message translates to:
  /// **'Continue with Passkey'**
  String get continueWithPasskey;

  /// No description provided for @scanQrCodeAction.
  ///
  /// In en, this message translates to:
  /// **'Scan QR code'**
  String get scanQrCodeAction;
  ...
  /// No description provided for @badResponseFormat.
  ///
  /// In en, this message translates to:
  /// **'Bad response format'**
  String get badResponseFormat;

  /// No description provided for @incorrectCertificate.
  ///
  /// In en, this message translates to:
  /// **'Incorrect certificate as configured'**
  String get incorrectCertificate;
}
